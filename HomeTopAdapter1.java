...
public class HomeTopAdapter1 extends BaseAdapter {

    private Context context;
    private List<HomeTopItem> datas;

    public HomeTopAdapter1(Context context, List<HomeTopItem> datas) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder = null;
        if (view == null) {
            view = View.inflate(context,R.layout.home_activity_list3,null);
